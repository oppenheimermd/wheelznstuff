...
class TabDashboardView extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return BaseView<TabDashboardVM>(
        onModelReady: (model) {
          model.getVendors();
        },
  ...
  Widget buildTopVendors(TabDashboardVM tabDashboardVM){

    List<Padding> paddingElements = new List<Padding>();
    tabDashboardVM.vendors.forEach((vendorImage) {
